...
<div class="row">
    <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">EDIT BRAND PRODUCT
                </header>
                    ...
                    <div class="position-center">
                        @foreach ($edit_brand_product as $key  =>  $edit_value)    
                            <form role="form" action="{{URL::to('/update-brand-product/'.$edit_value->brand_id)}}" method= "post">
                                ...
                                <textarea style="resize:none;"class="form-control" name="brand_product_desc" id="" rows="3" >{{$edit_value->brand_desc}}</textarea>
                                </div>
